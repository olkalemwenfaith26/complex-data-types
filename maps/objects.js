...
//
////////////////////// YOUR CODE BELOW THIS LINE ///////////////////////
let coordsX = Math.pow(solarSystem.properties.location.x, 2)
let coordsY = Math.pow(solarSystem.properties.location.y, 2)
let coordsZ = Math.pow(solarSystem.properties.location.z, 2)
let sumCoords = coordsX + coordsY + coordsZ
let squareSumCoord = Math.sqrt(sumCoords)
let distanceFromOrigin = Math.round(squareSumCoord)
let astroUnit = solarSystem.properties.size / solarSystem.properties.planets[2].distance
let sizeInAUs = astroUnit.toFixed(2);
